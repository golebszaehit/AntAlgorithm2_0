...
public class Mrowka {
    ...
    boolean syta;
    String sciezka="";
    public int zjadaneJedzenie = (int) (Math.random() * (5 - 2) + 1);
    ...
    public void akcja(){
        ...
        switch (valor) {
            ...
            case 0:
                ...
                if (swiat.hmfood>=1){
                    syta=true;
                    swiat.hmfood = swiat.hmfood-zjadaneJedzenie;
                }
                ...
                System.out.println("hmfood: " + swiat.hmfood);
                System.out.println("zjadaneJedzenie: " + zjadaneJedzenie);
    ...
    void polej_sciezke() {
        ...
        //polanie w zaleznosci od ilsci pokarmu
        for (int i = 0; i < sciezka.length(); i++) {
            if (sciezka.charAt(i) != swiat.home) {
                swiat.punkty[sciezka.charAt(i) - 'a'].ferom += zjadaneJedzenie;
            }
        }
    }
    public void pokaz(){
